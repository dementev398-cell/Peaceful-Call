...
/**
 * @summary Delete a chat message (for me or for everyone)
 */
...
export const getDeleteChatMessageMutationOptions = <TError = ErrorType<ErrorPayload>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteChatMessageMutationError = ErrorType<ErrorPayload>

    /**
 * @summary Delete a chat message (for me or for everyone)
 */
export const useDeleteChatMessage = <TError = ErrorType<ErrorPayload>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteChatMessage>>, TError,{id: number;params?: DeleteChatMessageParams}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const forwardChatMessage = async (id: number,
    forwardChatMessageInput: ForwardChatMessageInput, options?: RequestInit): Promise<ChatMessage> => {

  return customFetch<ChatMessage>(getForwardChatMessageUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(forwardChatMessageInput)
  }
);}
...
export const getForwardChatMessageMutationOptions = <TError = ErrorType<ErrorPayload>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof forwardChatMessage>>, TError,{id: number;data: BodyType<ForwardChatMessageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof forwardChatMessage>>, TError,{id: number;data: BodyType<ForwardChatMessageInput>}, TContext> => {

const mutationKey = ['forwardChatMessage'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof forwardChatMessage>>, {id: number;data: BodyType<ForwardChatMessageInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  forwardChatMessage(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ForwardChatMessageMutationResult = NonNullable<Awaited<ReturnType<typeof forwardChatMessage>>>
    export type ForwardChatMessageMutationBody = BodyType<ForwardChatMessageInput>
    export type ForwardChatMessageMutationError = ErrorType<ErrorPayload>

    /**
 * @summary Forward a message to another conversation
 */
export const useForwardChatMessage = <TError = ErrorType<ErrorPayload>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof forwardChatMessage>>, TError,{id: number;data: BodyType<ForwardChatMessageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof forwardChatMessage>>,
        TError,
        {id: number;data: BodyType<ForwardChatMessageInput>},
        TContext
      > => {
